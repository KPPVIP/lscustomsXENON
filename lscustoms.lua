...
local garages = {
	[1] = { locked = false, 
	camera = { x = -215.51, y = -1329.13, z = 30.89, heading = 329.09 }, 
	driveout = { x = -205.93, y = -1316.64, z = 30.17, heading = 356.49 }, 
	drivein = { x = -205.62, y = -1314.99, z = 30.24, heading = 179.39 }, 
	outside = { x = -205.59, y = -1304.08, z = 30.61, heading = 359.79 }, 
	inside = { x = -212.36, y = -1325.48, z = 30.17, heading = 141.10 } 
	}
}
